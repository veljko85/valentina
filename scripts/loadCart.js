      ...
      return this.each(function () {
        ...
        priceBut.onclick = () => {
          if (cartPricesLoaded[0]) {
            ...
            let valentina180180Cart = 0;
            let valentina120180Cart = 0;
            let valentina60180Cart = 0;

            for (let i = 0; i < allFences.length; i++) {
              if (allFences[i][0].isVisible) valentina180180Cart += 1;
              if (allFences[i][1].isVisible) valentina120180Cart += 1;
              if (allFences[i][2].isVisible) valentina60180Cart += 1;
            }
