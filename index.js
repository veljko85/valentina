...
var createScene = function () {
  ...
  var valentina180180Arr = [];
  var valentina120180Arr = [];
  var valentina60180Arr = [];
  var allFences = [];
  ...
  function changePosAndScaleFence(valueToCount, activeFence) {
    ...
    if (fencesArr[activeFence].type == "valentina120180")
      fakeFences[activeFence].position.x = 0.3;
    if (fencesArr[activeFence].type == "valentina60180")
  ...
  var createRightFence = (posX, posZ, rotY, type) =>
    BABYLON.SceneLoader.ImportMeshAsync(
      ...
      function toActiveFence() {
        ...
        deleteFencePart.onclick = () => {
          if (activeFence > 0) {
            ...
            if (sturNum < 1) {
              setActivnesStyle(sturmankerCon, 3, 1, "active-text-color");
              strurmOn = false;
            } else {
              strurmOn = true;
            }
        ...
        if (fencesArr[activeFence].type == "valentina180180")
      ...
      fakeFence.position = new BABYLON.Vector3(
        getAbsPosX(result.meshes[11]) + 0.01,
        0.9,
      ...
      result.meshes[11].addChild(fakeFence);

      //POST CAP
      let rightPostCap = result.meshes[5];
      ...
      //METAL PART TO HOLD WOOD POST
      let rightMetalPart = result.meshes[4];
      rightMetalPart.material = rootMat;
      metalParts.push(rightMetalPart);
      rightMetalParts.push(rightMetalPart);

      //SMALL METAL PART TO HOLD WOOD POST
      let rightSmallMetalPartFront = result.meshes[3];
      let rightSmallMetalPartBack = result.meshes[1];
      let rightSmallMetalPartBoth = result.meshes[2];
      ...
      //WOOD POST
      let rightWoodPost = result.meshes[8];
      ...
      foundationRightStart.position = new BABYLON.Vector3(
        getAbsPosX(result.meshes[7]),
        0.0001,
        getAbsPosZ(result.meshes[7])
      );
      ...
      //STRUMANKER
      let rightStrVord = result.meshes[9];
      ...
      ///sturmanker Ruck
      let rightStrRuck = result.meshes[10];
      ...
      rightPostCap.addChild(result.meshes[11]);
      rightPostCap.addChild(result.meshes[12]);
      ...
      let valentina180180 = result.meshes[11];
      valentina180180Arr.push(valentina180180);
      valentina180180.isVisible = false;
      let valentina120180 = result.meshes[12];
      valentina120180Arr.push(valentina120180);
      valentina120180.isVisible = false;
      let valentina60180 = result.meshes[13];
      valentina60180Arr.push(valentina60180);
      valentina60180.isVisible = false;
      ...
      if (type == "valentina180180") valentina180180.isVisible = true;

      if (type == "valentina120180") {
        valentina120180.isVisible = true;
        setSmallerFenceSize(
          rightPost,
          rightPostCap,
          newFenceForwardSigns,
      ...
      if (type == "valentina60180") {
        valentina60180.isVisible = true;
        setSmallerFenceSize(
          rightPost,
          rightPostCap,
          newFenceForwardSigns,
  ...
  function handleTabActivnes() {
    if (!document.hidden) {
      createRightFence(0.99, 0, 0, "valentina180180");
  ...
  holzType.onclick = () => {
    if (postType == 1) {
      ...
      setActivnesStyle(befePfostenParts, 2, 0, "active-text-color");
    }
  };
  ...
  setActivnes(fencePostsParts, 1, "active-text-color");

  //set alu post size
  let befePfostenParts = document.getElementsByClassName(
    "set-part-befe-pfosten"
  );
  setActivnes(befePfostenParts, 2, "active-text-color");
  ...
  setActivnes(sturmankerCon, 3, "active-text-color");
  ...
  setActivnes(fenceSturmankerParts, 4, "active-text-color");
  ...
  function changeFenceFunction(c, d, h) {
    ...
    if (d == "valentina180180") {
      valentina180180Arr[h].isVisible = true;
    }
    if (d == "valentina120180") {
      valentina120180Arr[h].isVisible = true;
    }
    if (d == "valentina60180") {
      valentina60180Arr[h].isVisible = true;
    }
  ...
  changeFence[0].addEventListener("click", () => {
    changeFenceFunction(180, "valentina180180", activeFence);
  });
  changeFence[1].addEventListener("click", () => {
    changeFenceFunction(120, "valentina120180", activeFence);
  });
  changeFence[2].addEventListener("click", () => {
    changeFenceFunction(60, "valentina60180", activeFence);
  });
    ...
    if (fencesArr[activeFence].type == "valentina180180") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(180, "valentina180180", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "valentina120180") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(120, "valentina120180", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "valentina60180") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(60, "valentina60180", i);
        }
      }
    }
  };
